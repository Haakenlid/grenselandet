...
from .views import TicketCreateView, TicketPayView, TicketReceiptView, TicketStartView, PayMillTestView
...
urlpatterns = patterns(
    ...
    url(r'^(?P<hashid>\w+)/pay/$', PayMillTestView.as_view(), name='ticket-payment'),
